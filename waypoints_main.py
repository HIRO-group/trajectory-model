...
from trajectory_model.helper import plot_loss_function, plot_prediction_vs_real, plot_xyz
...
if __name__ == "__main__":
    ...
    if fit_model:
        ...
        model.save_weights(f'weights/sampler/{now}_acc_{round(acc_val, 2)}_loss_{round(loss_val, 2)}_data_num_{training_data_num}_epochs_{epochs}.h5')
        ...
        model.load_weights("weights/sampler/acc_0.85_loss_0.01_data_num_165_epochs_400.h5")
