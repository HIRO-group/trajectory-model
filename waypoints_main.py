...
if __name__ == "__main__":
    ...
    if fit_model:
        ...
        if save == 'y':
            model.save_weights(f'weights/position_sampler/{ctime_str()}_acc_{round(acc_val, 2)}_loss_{round(loss_val, 2)}_data_num_{training_data_num}_epochs_{epochs}.h5')
        ...
        model.load_weights("weights/position_sampler/acc_0.85_loss_0.01_data_num_165_epochs_400.h5")
