...
# cup_default_cartesian = np.array([-0.007746216841042042,0.04685171693563461,0.16710145771503448,0,0,0,1])
panda_a, panda_b, panda_c, panda_w = 0.72585053, -0.68729377, -0.02771771, -0.68779879
...
def new_rotate_panda_to_match_orientation(panda_trajectory):
