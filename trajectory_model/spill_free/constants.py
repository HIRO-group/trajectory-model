...
EMBED_PROP = 4 # radius_b, height, radius_u, fill_level
...
# short tumbler:
SHORT_TUMBLER_RADIUS_B = 2
SHORT_TUMBLER_HEIGHT = 3
SHORT_TUMBLER_RADIUS_U = 2
SHORT_TUMBLER_FILL_30 = 0.3
SHORT_TUMBLER_FILL_70 = 0.7

# tall tumbler:
TALL_TUMBLER_RADIUS_B = 2
TALL_TUMBLER_HEIGHT = 3
TALL_TUMBLER_RADIUS_U = 2
